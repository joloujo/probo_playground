...
This repository is a skeleton for you to use as a starting point for your own Kalman! You should use the existing architecture and scaffolding as much as is useful for your learning, and you are welcome to structure the simulator however you see fit. The `src/` folder contains a basic outline of recommended files, classes, and functions, but these are by no means a requirement or a complete pipeline.
...
To get the new code on this branch into your local repository, follow these steps:
