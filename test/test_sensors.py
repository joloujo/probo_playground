...
from sensors import LandmarkPinger, WheelEncoder
...
class TestSensors:
    ...
    def wheel_encoder(self, robot: Robot):
        return WheelEncoder(robot, lin_noise=0, ang_noise=0)
    ...
    def test_wheel_encoder_sample(self, robot: Robot, wheel_encoder: WheelEncoder):
